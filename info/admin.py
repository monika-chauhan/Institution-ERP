...
from .models import Dept, Class, Student, Attendance, Course, Teacher, Assign, AssignTime, AttendanceClass#,Account
...
#	list_display=('student','installments','fee','Status','Dept')
#	search_field=('student','Dept')
#	ordering=['student__name','Dept__name','installments','fee','status']
